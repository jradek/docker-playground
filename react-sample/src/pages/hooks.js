  ...
  return (
    <div className="row">
      <div className="col s12">
        <h5>useState() hook example</h5>
      </div>
      <button
        className="col s4 waves-effect waves-light btn-small"
...
const EffectHookExample = () => {
  ...
  return (
    <div className="row">
      ...
      <div className="col s8">{isLoading ? "Loading ..." : numberTrivia}</div>
    </div>
  );
};
  ...
  return (
    ...
    <div>
      ...
      <div className="row">
        <div className="col s12">
          <p>
            The contents of this site is based on this{" "}
            <a href="https://www.youtube.com/watch?v=f687hBjwFcM">tutorial</a>
          </p>
        </div>
      </div>
      <BasicHooksExample />
